...
import ViewStaffingNeed from "../dashboard/view-staffingNeed-dialog"
...
export function UserStaffingNeedTable({ staffingNeeds, pagination, currentPage, onPageChange }: StaffingNeedsTableProps) {
